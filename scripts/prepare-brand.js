...
function generateBackendEndpoint(config, outputPath) {
  ...
  *
  * Brand: ${config._meta.brand}
  * Environment: ${config.environment}
  * Generated: ${new Date().toISOString()}
  *
  * DO NOT EDIT MANUALLY - Changes will be overwritten
  * Edit the source config at: brands/${config._meta.brand}/config/env.${config.environment}.json
  */
  ...
  return [].concat(fontFiles)
    ...
    .map(font => {
      ...
      return {
        ...
        ext: font.ext,
        url: './brand-assets/Fonts/' + stripFontsSourcePrefix(font.relativePath),
        weight,
        style
      };
    });
...
function getBrandLogoUrl(brandPath) {
...
Options:
  --brand     Brand folder name (required)
